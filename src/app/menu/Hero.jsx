...
const Hero = () => {
    return (
        <div className='flex flex-col'>
            <div className='bg-[#1692CD] h-[60vh] flex relative md:pt-0'>
                <div className='md:w-1/2 md:bg-transparent h-full flex md:flex-col md:self-auto self-start md:z-10 z-[5]  justify-center md:px-0 px-10 relative md:bg-none'>
                    <div className={`${myFont.className} md:w-[90%] md:self-end pt-10 flex flex-col gap-4 md:mr-5 relative`}>
                ...
                <div className='md:relative z-0 md:flex md:w-1/2 absolute bottom-0 flex justify-start h-full w-full '>
                    <Image alt='Cartoon__Girl' className='md:relative absolute bottom-0 mt-auto' width={500} src={cartoon} />
