...
const CoreValues = () => {
    return (
        <section className='bg-[#FEF9F5] w-full pt-16 flex flex-col gap-16 items-center md:px-12 mb-16'>
            <span className='flex flex-col items-center'>
                ...
                <section class="grid grid-cols-auto gap-10 md:grid-cols-2 justify-items-center px-4 md:px-auto">
                    <div className='w-[365px] md:w-[485px] overflow-hidden px-10 flex flex-col justify-center items-center bg-contain bg-no-repeat h-[325px]  md:min-h-[445px] bg-[url("../../public/assets/coreValue.png")] '>
                        ...
                        <p className='text-center font-sans text-[#333333] md:text-lg text-base mt-2'>We believe that cooking is an essential life skill and a form of artistic expression. Our club is dedicated to fostering a passion for cooking in every member, young or old.</p>
                    </div>
                    <div className='w-[365px] md:w-[485px] h-[325px] overflow-hidden px-10 bg-contain  flex flex-col justify-center items-center bg-no-repeat md:min-h-[445px] bg-[url("../../public/assets/coreValue2.png")] '>
                        <h2 className='md:text-6xl text-4xl text-[#0E609D] opacity-10 mb-2'>02</h2>
                        <span className='text-[#0E609D] md:text-2xl text-xl w-[240px] text-center'>Education Through Experience</span>
                        <p className='text-center font-sans md:text-lg text-base text-[#333333] mt-2'>Our interactive lessons and step-by-step tutorials make learning to cook accessible and enjoyable. We focus on practical skills that will serve our members for a lifetime.</p>
                    </div>
                    <div className='w-[365px] md:w-[485px] h-[325px] overflow-hidden px-10 bg-contain  flex flex-col justify-center items-center bg-no-repeat md:min-h-[445px] bg-[url("../../public/assets/coreValue2.png")] '>
                        <h2 className='md:text-6xl text-4xl text-[#0E609D] opacity-10 mb-2'>03</h2>
                    ...
                    <div className='w-[365px] md:w-[485px] h-[325px] overflow-hidden px-10 bg-contain  flex flex-col justify-center items-center  bg-no-repeat md:min-h-[445px] bg-[url("../../public/assets/coreValue.png")] '>
                        <h2 className='md:text-6xl text-4xl text-[#0E609D] opacity-10 mb-2'>04</h2>
                    ...
                    <div className='w-[365px] md:w-[485px] h-[325px] overflow-hidden px-10 bg-contain  flex flex-col justify-center items-center  bg-no-repeat md:min-h-[445px] bg-[url("../../public/assets/coreValue2.png")] '>
                        <h2 className='md:text-6xl text-4xl text-[#0E609D] opacity-10 mb-2'>05</h2>
                    ...
                    <div className='w-[365px] md:w-[485px] h-[325px] overflow-hidden px-10 bg-contain  flex flex-col justify-center items-center bg-no-repeat md:min-h-[445px] bg-[url("../../public/assets/coreValue.png")] '>
                        <h2 className='md:text-6xl text-4xl text-[#0E609D] opacity-10 mb-2'>06</h2>
