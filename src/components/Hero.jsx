...
const Hero = () => {
    ...
    return (
        <div className='h-[180vh] border border-black flex flex-col'>
            <div className='bg-[#1692CD] h-[1/2] w-full flex '>
                <div className='w-1/2 h-full flex flex-col  justify-center items-center relative'>
                    ...
                    <div className='w-3/4 self-end flex flex-col gap-4 mr-5 relative'>
                        ...
                        <button className='self-start flex items-center gap-1 text-white px-5 font-medium text-2xl bg-[#E6038A] rounded-full'>Let's Cokkin'<Image src={arrowRight} /></button>
